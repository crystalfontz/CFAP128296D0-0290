...
#if partialUpdate
  //NOTE: This demonstration is an example of how to initiate partial updates only.
  //      However, there are no OTP LUTs for partial updates. Each display will need to be 
  //      analyzed and the code that it runs on will have to have the proper LUTs stored.
